...
export default function FetchAllPgByOwner() {
	...
	if (allPgDetails.length === 0) {
		return <p>No data exists. Add a Pg first.</p>;
	}
	...
	return (
		<>
			...
			<div className="container d-flex flex-column align-items-center">
				...
				<div
					className="pgList"
					style={{ marginTop: 72, marginBottom: 348 }}
				>
